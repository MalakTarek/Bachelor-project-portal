...
{
    public partial class lecturerReg : System.Web.UI.Page
    {
        ...
        protected void LeReg(object sender, EventArgs e)
        {
            ...
            string fc = Page.Request.Form["facultyCode"].ToString();
            string x = null;
            ...
            regproc.Parameters.Add(new SqlParameter("@faculty_code", fc));
