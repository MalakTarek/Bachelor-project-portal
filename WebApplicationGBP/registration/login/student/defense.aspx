<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="defense.aspx.cs" Inherits="GiuBachelorPortal.student.defense" %>
...
<head runat="server">
   ...
   <body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Defense</asp:Label>
    ...
    <div style="margin:30px; float:right">
        <div>
            <asp:LinkButton ID="LinkButton7" runat="server"  BackColor="Aqua" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="4px" style="text-decoration: none; padding:5px; float:right" Font-Names="Cursive" ForeColor="#000066" OnClick="LinkButton7_Click"><i class="fas fa-eye"></i> View defense</asp:LinkButton><br /><br />
            <asp:LinkButton ID="LinkButton8" runat="server"  BackColor="Aqua" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="4px" style="text-decoration: none; padding:5px; float:right" Font-Names="Cursive" ForeColor="#000066" OnClick="LinkButton8_Click"><i class="fas fa-plus"></i> update defense content.</asp:LinkButton><br /><br />
        </div>
    </div>
    </form>
   </body>
