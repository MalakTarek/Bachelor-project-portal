<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thesis.aspx.cs" Inherits="GiuBachelorPortal.student.thesis" %>
...
<head runat="server">
   ...
   <body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Thesis</asp:Label>
    ...
    <div style="margin:30px; float:right">
        <div>
            <asp:LinkButton ID="LinkButton4" runat="server"  BackColor="Aqua" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="4px" style="text-decoration: none; padding:5px; float:right" Font-Names="Cursive" ForeColor="#000066" OnClick="LinkButton4_Click"><i class="fas fa-eye"></i> View thesis</asp:LinkButton><br /><br />
            <asp:LinkButton ID="LinkButton5" runat="server"  BackColor="Aqua" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="4px" style="text-decoration: none; padding:5px; float:right" Font-Names="Cursive" ForeColor="#000066" OnClick="LinkButton5_Click"><i class="fas fa-file-upload"></i> Submit their thesis</asp:LinkButton><br /><br />
        </div>
    </div>
    </form>
   </body>
