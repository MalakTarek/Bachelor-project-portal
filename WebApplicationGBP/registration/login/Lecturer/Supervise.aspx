<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supervise.aspx.cs" Inherits="GBP.registration.login.Lecturer.Supervise" %>
...
<body>
        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Supervise</span>
    ...
    <form id="form1" runat="server">
        <div>
         ...
         <div class="field padding-bottom--24">
        <asp:Button ID="Super" runat="server"  Text="Supervise" OnClick="Button_Click" />
             </div>
    </form>
                </div>
    </div>
