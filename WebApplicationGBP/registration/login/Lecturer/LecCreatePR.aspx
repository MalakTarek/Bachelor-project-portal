<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LecCreatePR.aspx.cs" Inherits="GBP.registration.login.Lecturer.LecCreatePR" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br/>
            Content<br />
            <asp:TextBox ID="Content" MaxLength="1000" runat="server"  BorderStyle="Ridge" BorderWidth="4px" required="required"></asp:TextBox>
            <br />
